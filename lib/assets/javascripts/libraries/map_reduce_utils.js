...
root.map = function(logic,record, population, denominator, numerator, exclusion, denexcep, msrpopl, msrpoplex, observ, occurrenceId, isContinuousVariable, stratification,variables, correlation_id) {
  var value = {IPP: 0, patient_id: record.id(),
               medical_record_id: record.medicalRecordNumber(),
               first: record.given(), last: record.last(), gender: record.gender(),
               birthdate: record.birthtime(),
